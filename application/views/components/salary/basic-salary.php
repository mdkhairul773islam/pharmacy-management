...
<div class="container-fluid" ng-controller="PayrollCtrl">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" ng-submit="saveDataFn()">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" ng-model="data.basic" class="form-control" required>
                ...
                <div class="col-md-6">
                    <figure class="info-view" ng-if="profile.active" ng-cloak>
                        ...
                        <figcaption>
                            ...
                            <p><strong>Post:</strong> {{ profile.post }}</p>
