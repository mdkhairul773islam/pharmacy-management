...
<!--<script src="<?php //echo site_url('private/js/ngscript/SaleEntryCtrl.js?') . time(); ?>"></script>-->
<script src="<?php echo site_url('private/js/ngscript/CreditSaleCtrl.js?') . time(); ?>"></script>
...
<div class="container-fluid" id="screen_area" ng-controller="CreditSaleCtrl">
    <div class="row">
        <?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel page_ctrl panel-default">
            <div class="panel-body" ng-cloak>
                <div class="row">
                    <form action="<?php echo site_url('sale/credit/store');?>" method="post">
                        <div class="col-md-7">
                         <!-- horizontal form -->
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="table_style">
                                <table class="table table-bordered table2 custom_sale_table">
                                    ...
                                    <tr ng-repeat="item in cart">
                                        ...
                                        <td>
                                            <input type="text" name="product_name[]" class="form-control" ng-model="item.product_name" readonly>
                                            <input type="hidden" name="id[]" ng-value="item.id">
                                            <input type="hidden" name="product_code[]" ng-value="item.product_code">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" ng-value="item.subcategory" readonly>
                                        </td>
                                        <td>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select id="client_info" name="party_code" class="selectpicker form-control" data-show-subtext="true" data-live-search="true"  required >
                                            ...
                                            <input type="hidden" name="stype" value="credit">
                                        </div>
                                    </div>
                                </div>
                            </div>
