...
<div class="container-fluid" id="screen_area" ng-controller="SaleEntryCtrl">
    <div class="row">
        <?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel page_ctrl panel-default">
            <div class="panel-body" ng-cloak>
                <div class="row">
                    <form action="<?php echo site_url('sale/sale/store');?>" method="post">
                        <div class="col-md-7">
                            <!-- horizontal form -->
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="hidden" name="stype" value="cash">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
