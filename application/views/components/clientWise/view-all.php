    ...
    <div class="row">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-5">
                        <select name="client_code"  class="selectpicker form-control" required data-show-subtext="true" data-live-search="true" >
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading panal-header">
                <div class="panal-header-title">
                    <h1 class="pull-left">Client Wise All Products</h1>
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <?php $grandTotal=0.00; foreach($getData as $key => $value){
                            $getClient = $this->action->read('parties',array('code'=>$value->client_code));
                            $getproduct = $this->action->read('products',array('product_code'=>$value->product_code));
                            $grandTotal += $value->price;
                        ?>
                        <tr>
                            <td width="45"> <?php echo ($key+1); ?> </td>
                            <td><?php echo filter($getClient[0]->name); ?></td>
                            <td><?php echo filter($getproduct[0]->product_name); ?></td>
                            <td><?php echo $value->price; ?></td>

                            <td class="none" >
                                <a class="btn btn-warning" title="Edit" href="<?php echo site_url('clientWise/clientWise/edit/'.$value->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                <a class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure want to delete this Product?');" href="<?php echo site_url('clientWise/clientWise/delete/'.$value->id) ;?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                        <tr>
