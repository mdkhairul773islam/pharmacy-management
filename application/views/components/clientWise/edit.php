        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="client"  class="selectpicker form-control" required data-show-subtext="true" data-live-search="true" >
                            ...
                            <option <?php if($getData[0]->client_code==$value->code){echo "selected";} ?> value="<?php echo $value->code; ?>"><?php echo filter($value->name)." ( ".$value->address." ) "; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        ...
                        <select name="product" class="selectpicker form-control" data-show-subtext="true" data-live-search="true" required>
                            ...
                            <option  <?php if($getData[0]->product_code == $row->product_code){echo "selected";} ?> value="<?php echo $row->product_code; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" name="price" step="any" min="0.00" value="<?php echo $getData[0]->price; ?>" class="form-control" required>
                    </div>
                </div>
