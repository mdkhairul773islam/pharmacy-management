    ...
    <div class="row" ng-controller="SupplierEditTransactionCtrl" ng-cloak>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Previous Remission (TK) <span class="req"></span></label>
                    <div class="col-md-5">
                        <input type="number" value="<?= $records[0]->remission ?>" class="form-control" step="any" min="0" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" name="remission" ng-model="remission" ng-init="remission=0" class="form-control" step="any" min="0">
                    </div>
                </div>
                <div class="form-group">
