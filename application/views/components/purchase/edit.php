    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('purchase/edit_purchase/update', $attr);
                ?>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            <input type="date" name="expire_date[]" class="form-control" ng-value="item.expire_date" readonly>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="number" name="old_quantity[]" class="form-control" min="0"
                                   ng-model="item.old_quantity" readonly>
                        </td>
                        <td>
