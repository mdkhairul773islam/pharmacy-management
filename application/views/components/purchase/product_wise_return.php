            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            <input type="text" name="batch_no[]" class="form-control" ng-model="item.batch_no" readonly>
                        </td>
                        <td>
                            <input type="text" name="expire_date[]" class="form-control" ng-model="item.expire_date" readonly>
                        </td>
                ...
                <div class="row">
                    <div class="col-md-offset-6 col-md-6">
                        ...
                        <input type="hidden" name="paid" ng-model="payment" ng-value="payment" class="form-control" step="any">
...
<script>
    ...
    function dropdownData() {
        ...
        text_arr["<?php echo $sl; ?>"] = "<?php echo $row->name . "-" . filter($row->category); ?>";
