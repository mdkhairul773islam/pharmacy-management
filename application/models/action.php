...
class Action extends Lab_Model {
    ...
    public function search_product($name){
        $sql = "SELECT * FROM `stock` where name like '$name%' order by name asc";
        $query = $this->db->query($sql);
        return $query->result();
    }
...
/*
  ...
  public function readPagination($table,$per_page,$offset,$order="asc")
    ...
    // get join all data
    public function get_join($tableFrom, $tableTo, $joinCond, $where = [], $select = null, $groupBy = null, $order_col = null, $order_by = 'desc', $limit = null, $limit_offset = null, $where_in = null)
    {
