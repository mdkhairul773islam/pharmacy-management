<?php
// set site name
$config['site_name'] = 'এস আলম ফার্মেসী';
$config['my_database'] = 'jomjahjl_lifecare';
$config['total_sms'] = 10;
...
// Self Name
$config['self_name'] = array('Self 1', 'Self 2', 'Self 3', 'Self 4', 'Self 5');

// print heading
$config['heading'] = array(
    'title' => 'Al Ara Drug House',
    'place' => 'Station Road, Sadar, Mymensingh'
);
...
//unit
$config['unit'] = array("ml", "mg", "gm", "pot", "pcs");
...
//server configuration
 $config['configuration'] = array(
    'protocol'  => 'smtp',
    'smtp_host' => 'mail.al-ara.com',
    'smtp_port' =>  26,
    'smtp_user' => 'support@al-ara.com',
    'smtp_pass' => '}yn$qADF1KtO',
    'mailtype'  => 'html',
    'charset'   => 'utf-8'
);
$config['domain'] = array("al-ara.com");