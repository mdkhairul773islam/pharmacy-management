...
class Cost extends Admin_Controller {
    ...
    public function index() {
        ...
        if($this->input->post('update')){
            $data = array("cost_field"=> str_replace(" ","_",$this->input->post('new_name')));
            $where = array('cost_field' => $this->input->post('old_name'));
            
            // update cost_field name in cost_field table
            $this->action->update('cost_field',$data,$where);
            
            // update cost_field in cost table
