<?php
class New_sale extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subMenu']      = 'data-target="new_sale"';
        ...
        $this->data['allParty'] = get_result('parties', ['type' => 'client', 'status' => 'active', 'trash' => 0]);

        $this->load->view($this->data['privilege'] . '/includes/header', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/aside', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        // $this->load->view('components/sale/nav', $this->data);
        $this->load->view('components/sale/new_sale', $this->data);
        ...
        if (!empty($_POST['save'])) {
            ...
            foreach ($_POST['id'] as $key => $value){
                ...
                if($_POST['product_code'][$key] ==20140){
                    ...
                    $data['manufacturer'] = $_POST['manufacturer'][$key];
                }    
