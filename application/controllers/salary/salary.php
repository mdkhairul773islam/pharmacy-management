    ...
    public function index($emit = NULL) {
        ...
        $this->data['confirmation'] = null;
            ...
            if ($this->input->post('save_data')) {
              ...
              $this->data['confirmation'] = message($this->action->add('basic_salary', $data), $msg_array);
            }
            ...
            if ($this->input->post('update_data')) {
              ...
              $this->data['confirmation'] = message($this->action->update('basic_salary', $data,array("emp_id" => $this->input->post('emp_id'))), $msg_array);
            }
