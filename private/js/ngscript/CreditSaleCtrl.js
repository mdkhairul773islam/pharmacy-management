// sale controller
app.controller('CreditSaleCtrl', function ($scope, $http) {
    ...
    // get cliend info
    $('#client_info').on('change', function () {
            ...
            $http({
                ...
                if (response.length > 0) {
                    ...
                    $http({
                        ...
                        var balance = (parseFloat(response[0].initial_balance) + parseFloat(debit) - parseFloat(credit)).toFixed(2);
